    ...
    <div className="space-y-12">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {product.features.map((feature) => (
              <motion.div
                key={feature.id}
                className="p-4 rounded-lg bg-slate-800/30 hover:bg-slate-800/50 transition-colors duration-300 border border-slate-700/50"
          ...
          <div className="bg-slate-800/20 rounded-lg border border-slate-700/30 p-6">
            {product.specifications.map((spec, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="py-3 border-b border-slate-800/50 last:border-b-0 flex justify-between items-start"
      ...
      <section className="border-t border-slate-800/50 pt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Shipping */}
          <motion.div
            className="p-4 rounded-lg bg-slate-800/20 border border-slate-700/30"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.3 }}
            viewport={{ once: true }}
          >
            <div className="flex gap-3 items-start">
              ...
              <div>
                <h4 className="font-semibold text-white text-sm mb-1">Fast Shipping</h4>
          ...
          {product.returns && (
            ...
            >
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="font-semibold text-white text-sm mb-1">Easy Returns</h4>
                  <p className="text-xs text-slate-400">
          ...
          {product.warranty && (
            ...
            >
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="font-semibold text-white text-sm mb-1">Warranty</h4>
                  <p className="text-xs text-slate-400">
          ...
          >
            <div className="flex gap-3 items-start">
              ...
              <div>
                <h4 className="font-semibold text-white text-sm mb-1">Quality Assured</h4>
                <p className="text-xs text-slate-400">
